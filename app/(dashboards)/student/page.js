      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Discover new opportunities and find your perfect match
          </p>
        ...
        <div className="bg-white border rounded-lg p-6">
          ...
          {recentApplications.length === 0 ? (
            <div className="text-center py-4">
              <p className="text-black-500 mb-2">No applications yet</p>
              <Button
                onClick={() => router.push("/student/jobs")}
      ...
      {stats.hired > 0 && (
        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-sm text-green-700">
            You have been hired for {stats.hired} position
            {stats.hired > 1 ? "s" : ""}! Check your applications for more
            details.
          </p>
        </div>
      )}
      ...
      {stats.interviews > 0 && (
        <div className="mt-4 bg-purple-50 border border-purple-200 rounded-lg p-4">
          ...
          <p className="text-sm text-purple-700">
            ...
            {stats.interviews > 1 ? "s" : ""} scheduled. Check your email and
