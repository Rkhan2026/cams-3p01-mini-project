/**
 * Consolidated icon components for dashboard pages
 * All icons used across dashboard pages are centralized here for easy maintenance
 */
...
export const ExclamationTriangleIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const InformationCircleIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// Action Icons (extracted from inline definitions)
...
export const UserAddIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// More specific icons for TPO dashboard
...
export const BuildingOfficeIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const ClipboardDocumentListIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
